...
from reinforcement_learning.model import DuelingQNetwork, DQN
...
class DDDQN_UCBPolicy(Policy):
    ...
    def act(self,handle, state, eps=0.):
        ...
        upperconfidencebound = torch.tensor([(1.01**self.action_time_dict[0])*math.sqrt(2*math.log(self.action_counter, math.e)/self.action_counter_dict.get(0)),
                                             (1.01**self.action_time_dict[1])*math.sqrt(2*math.log(self.action_counter, math.e)/self.action_counter_dict.get(1)),
                                             (1.01**self.action_time_dict[2])*math.sqrt(2*math.log(self.action_counter, math.e)/self.action_counter_dict.get(2)),
                                             (1.01**self.action_time_dict[3])*math.sqrt(2*math.log(self.action_counter, math.e)/self.action_counter_dict.get(3)),
                                             (1.01**self.action_time_dict[4])*math.sqrt(2*math.log(self.action_counter, math.e)/self.action_counter_dict.get(4))])
        ...
        return np.argmax(torch.add(action_values, upperconfidencebound).cpu().data.numpy())
