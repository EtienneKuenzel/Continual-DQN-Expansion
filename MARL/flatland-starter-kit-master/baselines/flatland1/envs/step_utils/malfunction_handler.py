...
def get_number_of_steps_to_break(malfunction_generator, distance_map, np_random, agent):
    if hasattr(malfunction_generator, "generate"):
        malfunction = malfunction_generator.generate(distance_map, np_random, agent)
    else:
...
class MalfunctionHandler:
    ...
    def generate_malfunction(self, malfunction_generator, distance_map, np_random, agent):
        num_broken_steps = get_number_of_steps_to_break(malfunction_generator, distance_map, np_random, agent)
